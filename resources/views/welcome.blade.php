                ...
                <header class="bg-black py-5">
                  <div class="container px-5">
                      <div class="row gx-5 align-items-center justify-content-center">
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="../images/student-passing-online-exam-home-student-passing-online-exam-home-closeup-181815769.jpg" alt="..." /></div>
                          <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                  <h1 class="display-5 fw-bolder text-white mb-2"> Examation System</h1>
                                  <p class="lead fw-normal text-white-50 mb-4"> إنشاء اختبارات إلكتروني أون لاين من برنامج سهل الاستخدام</p>
                                  <p class="lead fw-normal text-white-50 mb-4">ومستقر وكامل للاستخدام في الجامعات </p>
                                  <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                      <a class="btn btn-info text-white btn-lg px-4 me-sm-3" href="/register">Get Started</a>
                                      <a class="btn btn-outline-light text-white btn-lg px-4" href="/desc">Learn More</a>
                                  </div>
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="row gx-5">
                              <div class="col-lg-4 mb-5">
                                  <div class="card h-100 shadow border-0">
                                      <img class="card-img-top" src="../images/online_exams.png" alt="..." />
